	...
	const LogoCardComponenet = ({
		...
		return (
			<div className='view-asset view-asset-website'>
				<span className='close-X' onClick={closeWebCard}>
					X
				</span>
				<img
					src={imageOne}
					className='view-asset_img-one'
					alt='web design'
				/>
				<div className='view-asset_title-desc'>
					<a href={`http://${link}`} className='view-asset_title'>
						{title}
					</a>
