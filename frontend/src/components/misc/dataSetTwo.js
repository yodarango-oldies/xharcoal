...
const dataSetTwo = {
	One: {
		...
		stepOne:
			'Responsive to all device sizes. Implemented with 100% custom CSS code.',
		stepTwo:
			'Built from scracth with 100% custom javascript code for an interactive, smooth, and snappy user experience.',
		stepThree:
			'Implemented only with the best and latest SEO practices assuring great google ranking.',
	...
	Two: {
		...
		stepOne:
			'Responsive to all device sizes. Implemented with custom CSS code and best Wordpress plugins.',
		stepTwo:
			'Built with Wordpress and complemented with custom code for great performance',
		stepThree:
			'Implemented only with the best and latest SEO practices assuring great google ranking.',
		link: 'nswhitley.com',
	},
